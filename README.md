...
- [supabase-community/supabase_auth_ui](https://github.com/supabase-community/supabase_auth_ui) - Supabase Auth UI library for Flutter
...
- [open-workflow-specification/specification](https://github.com/open-workflow-specification/specification) - Contains the official specification for the Open Workflow Specification Domain Specific Language. It provides detailed guidelines and standards for defining, executing, and managing workflows in serve
...
- [getopenscreen/openscreen](https://github.com/getopenscreen/openscreen) - Create stunning demos for free. Open-source, no subscriptions, no watermarks, and free for commercial use. An alternative to Screen Studio.
...
- [crosswk/SayIt](https://github.com/crosswk/SayIt) - 语音输入 + AI 润色，开源 Typeless 替代品。支持个人使用和团队/企业内部自部署。按下快捷键说话，文字自动输入到任何应用。
...
- [saltbo/zme](https://github.com/saltbo/zme) - 
...
- [realmroot/realmroot](https://github.com/realmroot/realmroot) - Identity and delegated access for agents, apps, and people.
...
- [davidhckh/portfolio-2025](https://github.com/davidhckh/portfolio-2025) - Interactive developer portfolio built with Three.js, Vue and modern web technologies, focused on immersive user experiences, smooth animations and high-performance frontend architecture.
...
- [marswaveai/coli](https://github.com/marswaveai/coli) - Core library for Cola. Provides essential capabilities commonly used by agents.
...
- [chekusu/sandbank](https://github.com/chekusu/sandbank) - unified agent workspace
...
- [bohd4nx/app-landing](https://github.com/bohd4nx/app-landing) - 100% vibe-coded mobile app landing page template — built with Next.js, React, and Tailwind CSS. Drop in your app's content, deploy, done.
